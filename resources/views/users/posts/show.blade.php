            ...
            <div class="card border-0">
                <div class="card-header bg-white py-3">
                    <div class="row align-items-center">
                        ...
                        <div class="col-auto">
                            <!-- If you are owner the post, you can delete and edit this post  -->
                            ...
                            @else
                            <!-- Follow button -->
                            <!-- If you are Not owner the post, show a follow/unfollow button  -->
                                @if($post->user->isFollowed())
                                    <form action="{{ route('follow.destroy',$post->user->id)}}" method="post" class="d-inline">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit" class="border-0 bg-transparent p-0 text-secondaey">Following</button>
                                    </form>
                                @else
...
<!-- Heart button, no of likes, categories -->
                ...
                <!-- Owner, desccription,date   xsmall is for CSS not Bootstrap-->
                    ...
                    <div class="mt-3">
                        <form action="{{ route('comment.store', $post->id) }}" method="post">
                            ...
                            <div class="input-group">
                                <textarea name="comment_body{{ $post->id }}" id="" cols="30" rows="1" class="form-control-sm" placeholder="Add a comment..">{{ old('comment_body'. $post->id) }}</textarea>
                ...
                <!-- show all comments here different place with comments-->
                        ...
                        <ul class="list-group mt-2">
                            ...
                            <!-- Delete comment -->
                                <form action="{{ route('comment.destroy', $comment->id )}}" method="post">
                                    ...
                                    <!-- If the Auth user is owner of the comment ,show Delete btn -->
