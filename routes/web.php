...
#Profile
    ...
    Route::patch('profile/update', [ProfileController::class, 'update'])->name('profile.update');
     ...
     // Show follollowers name
    Route::get('/follow/{user_id}/followers', [ProfileController::class, 'followers'])->name('profile.followers');
    // Show follollowing users name
...
# FOLLOW
    ...
    // Show follollowers name
    // Route::get('/follow/{user_id}/show', [ProfileController::class, 'followers'])->name('profile.followers');
